...
import { SessionRepo, BoardRepo } from "../../core/repos.js";
...
export function mountSessions(root) {
  ...
  const blurb = el("div", { class: "jsp-blurb", text: "Plan a run of boards — a session references boards, so one board can be reused across many sessions." });
